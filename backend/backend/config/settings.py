...
# Przekieruj na stronę główną po zalogowaniu/wylogowaniu
LOGIN_REDIRECT_URL = '/'
LOGOUT_REDIRECT_URL = '/'

# Gdzie Django ma wysyłać "nieproszonych gości" (niezalogowanych):
LOGIN_URL = 'login'

# Mówimy Django: "Zamiast domyślnego Usera, używaj modelu 'Uzytkownik' z aplikacji 'snippets'"
AUTH_USER_MODEL = 'snippets.Uzytkownik'
