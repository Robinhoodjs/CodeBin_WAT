    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numer_indeksu', models.CharField(blank=True, max_length=5, null=True, verbose_name='Numer indeksu')),
                ('grupa_dziekanska', models.CharField(blank=True, max_length=20, null=True, verbose_name='Kod Grupy')),
