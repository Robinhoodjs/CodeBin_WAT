...
s = open(r'/backend/generator/src/agents/controller.py', encoding='utf-8').read()
...
s2 = open(r'/backend/generator/src/agents/input_reader.py', encoding='utf-8').read()
...
s3 = open(r'/backend/generator/src/agents/description_creator.py', encoding='utf-8').read()
...
s4 = open(r'/backend/generator/src/agents/output_describer.py', encoding='utf-8').read()
